    ...
    import '../styles/Tarefa.scss';  // Certifique-se de que o caminho do arquivo esteja correto

    export default function Tarefa() {
        const [tarefas, setTarefas] = useState([]);
        const [erro, setErro] = useState('');
        const [statusFiltro, setStatusFiltro] = useState('fazer');  // Estado para o filtro de status
        ...
        const fetchTarefas = async () => {
            try {
                ...
                if (response.ok) {
                    ...
                    setTarefas(data);  // Armazena as tarefas filtradas no estado
                } else {
